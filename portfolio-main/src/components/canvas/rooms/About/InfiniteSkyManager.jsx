...
const AWARDS_DATA = {
    featured: {
        ...
        title: 'Core Expertise & Highlights',
        items: [
            { label: 'WordPress Core Development', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'Technical SEO Strategies', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'Video Editing & Production', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'Google AdSense Monetization', date: 'Active', image: '/textures/about/button.webp', url: '#' },
        ],
        platformConfig: {
            label: 'EXPERTISE',
            color: '#311059',
