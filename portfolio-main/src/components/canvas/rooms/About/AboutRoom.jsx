...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'VIGNESHWARAN', subtitle: '< ai engineer • data analyst • web developer />' },
    { id: 'focus', position: [0, 0, -55], type: 'awards', title: 'FOCUS', subtitle: 'LLMs • NLP • Analytics • Automation' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'Building intelligent applications and data-led products' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'Python • React • FastAPI • SQL • Cloud' },
];
